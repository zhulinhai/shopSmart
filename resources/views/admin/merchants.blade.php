                        ...
                        <tbody>
                            @foreach ($merchants as $merchant)
                                <tr>
                                    ...
                                    <td><p>名称：{{ $merchant->name }}</p><p>电话：{{ $merchant->tel }}</p><p>地址：{{ $merchant->address }}</p><p>类型：{{ $merchant->category_id?($categories?$categories[$merchant->category_id]:'未知'):'未知' }}</p><p>上传时间：{{ $merchant->updated_at }}</p></td>
                                    <td>
                                        <div class="btn-group">
