...
@section('content')
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title"><a><i class="glyphicon glyphicon-home"></i> 标签编辑</a><a href="{{ url('/admin/tags') }}" class="pull-right" style="color: #CA2623"><i class="glyphicon glyphicon-backward"></i> 返回</a></div>
        </div>
        <div class="panel-body" >
            {{ Form::model($tag,['method'=>'PATCH','url' => 'tags/'.$tag->id , 'enctype' => 'multipart/form-data']) }}
